...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("! Sᴇɴᴅ Aʟʟ Tᴏ PM !", url=f"https://telegram.me/{temp.U_NAME}?start=send_fall#files#{offset}#{req}"),
...
async def language_check(bot, query):
    ...
    if files:
        ...
        btn.insert(0, [
            InlineKeyboardButton("! Sᴇɴᴅ Aʟʟ Tᴏ PM !", url=f"https://telegram.me/{temp.U_NAME}?start=send_fall#{pre}#{0}#{userid}"),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("! Sᴇɴᴅ Aʟʟ Tᴏ PM !", url=f"https://telegram.me/{temp.U_NAME}?start=send_fall#{pre}#{0}#{message.from_user.id}"),
